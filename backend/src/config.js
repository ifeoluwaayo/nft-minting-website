...
const namePrefix = "fomodogz";
const description = "This is my FOMODOGZ cool project";
...
const CONTRACT_NAME = "fomodogz";
const CONTRACT_SYMBOL = "FDZ";
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = "0x581251Be14e4d57ccb9C78bBD38c3ECeF4b894b7";
const TREASURY_ADDRESS = "0x581251Be14e4d57ccb9C78bBD38c3ECeF4b894b7";
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0xdA1463d272eD3df3Eb7557d22003dc13615A5799"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Which dog is yours...?"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE =
	"https://ipfs.io/ipfs/bafkreic3hdbp3b5zduo7aww2t6sp35gc4kmqknssvoxdv3y7peflbgvhbi"; // Replace with your generic image that will display for all NFTs pre-reveal.
